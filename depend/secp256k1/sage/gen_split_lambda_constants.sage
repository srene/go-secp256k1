""" Generates the constants used in kaspa_secp256k1_scalar_split_lambda.

See the comments for kaspa_secp256k1_scalar_split_lambda in src/scalar_impl.h for detailed explanations.
"""
...
def find_split_constants_gauss():
    """Find constants for kaspa_secp256k1_scalar_split_lamdba using gauss reduction."""
    (v11, v12), (v21, v22) = gauss_reduction([0, N], [1, int(LAMBDA)])

    # We use related vectors in kaspa_secp256k1_scalar_split_lambda.
    A1, B1 = -v21, -v11
    A2, B2 = v22, -v21
...
def find_split_constants_explicit_tof():
    """Find constants for kaspa_secp256k1_scalar_split_lamdba using the trace of Frobenius.
    ...
    # We use a negated b values in kaspa_secp256k1_scalar_split_lambda.
    B1, B2 = -B1, -B2
...
def scalar_lambda_split(k):
    """Equivalent to kaspa_secp256k1_scalar_lambda_split()."""
    c1 = rnddiv2((k * G1) >> 383)
    c2 = rnddiv2((k * G2) >> 383)
    c1 = (c1 * -B1) % N
    c2 = (c2 * -B2) % N
