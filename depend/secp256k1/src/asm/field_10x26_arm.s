...
*/
	...
	.align	2
	.global kaspa_secp256k1_fe_mul_inner
	.type	kaspa_secp256k1_fe_mul_inner, %function
	@ Arguments:
...
kaspa_secp256k1_fe_mul_inner:
	...
	*/
	...
	.size	kaspa_secp256k1_fe_mul_inner, .-kaspa_secp256k1_fe_mul_inner

	.align	2
	.global kaspa_secp256k1_fe_sqr_inner
	.type	kaspa_secp256k1_fe_sqr_inner, %function
	@ Arguments:
...
kaspa_secp256k1_fe_sqr_inner:
	...
	*/
	...
	add	sp, sp, #48
	ldmfd	sp!, {r4, r5, r6, r7, r8, r9, r10, r11, pc}
	.size	kaspa_secp256k1_fe_sqr_inner, .-kaspa_secp256k1_fe_sqr_inner
