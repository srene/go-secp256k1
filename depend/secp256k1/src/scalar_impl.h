...
#ifndef kaspa_secp256k1_SCALAR_IMPL_H
#define kaspa_secp256k1_SCALAR_IMPL_H
...
static const kaspa_secp256k1_scalar kaspa_secp256k1_scalar_one = kaspa_secp256k1_SCALAR_CONST(0, 0, 0, 0, 0, 0, 0, 1);
static const kaspa_secp256k1_scalar kaspa_secp256k1_scalar_zero = kaspa_secp256k1_SCALAR_CONST(0, 0, 0, 0, 0, 0, 0, 0);

static int kaspa_secp256k1_scalar_set_b32_seckey(kaspa_secp256k1_scalar *r, const unsigned char *bin) {
    int overflow;
    kaspa_secp256k1_scalar_set_b32(r, bin, &overflow);
    return (!overflow) & (!kaspa_secp256k1_scalar_is_zero(r));
}
 ...
 * lambda is: */
static const kaspa_secp256k1_scalar kaspa_secp256k1_const_lambda = kaspa_secp256k1_SCALAR_CONST(
    0x5363AD4CUL, 0xC05C30E0UL, 0xA5261C02UL, 0x8812645AUL,
    0x122E22EAUL, 0x20816678UL, 0xDF02967CUL, 0x1B23BD72UL
);

#ifdef VERIFY
static void kaspa_secp256k1_scalar_split_lambda_verify(const kaspa_secp256k1_scalar *r1, const kaspa_secp256k1_scalar *r2, const kaspa_secp256k1_scalar *k);
#endif
 ...
 */
static void kaspa_secp256k1_scalar_split_lambda(kaspa_secp256k1_scalar *r1, kaspa_secp256k1_scalar *r2, const kaspa_secp256k1_scalar *k) {
    kaspa_secp256k1_scalar c1, c2;
    static const kaspa_secp256k1_scalar minus_b1 = kaspa_secp256k1_SCALAR_CONST(
        0x00000000UL, 0x00000000UL, 0x00000000UL, 0x00000000UL,
        0xE4437ED6UL, 0x010E8828UL, 0x6F547FA9UL, 0x0ABFE4C3UL
    );
    static const kaspa_secp256k1_scalar minus_b2 = kaspa_secp256k1_SCALAR_CONST(
        0xFFFFFFFFUL, 0xFFFFFFFFUL, 0xFFFFFFFFUL, 0xFFFFFFFEUL,
        0x8A280AC5UL, 0x0774346DUL, 0xD765CDA8UL, 0x3DB1562CUL
    );
    static const kaspa_secp256k1_scalar g1 = kaspa_secp256k1_SCALAR_CONST(
        0x3086D221UL, 0xA7D46BCDUL, 0xE86C90E4UL, 0x9284EB15UL,
        0x3DAA8A14UL, 0x71E8CA7FUL, 0xE893209AUL, 0x45DBB031UL
    );
    static const kaspa_secp256k1_scalar g2 = kaspa_secp256k1_SCALAR_CONST(
    ...
    kaspa_secp256k1_scalar_mul_shift_var(&c1, k, &g1, 384);
    kaspa_secp256k1_scalar_mul_shift_var(&c2, k, &g2, 384);
    kaspa_secp256k1_scalar_mul(&c1, &c1, &minus_b1);
    kaspa_secp256k1_scalar_mul(&c2, &c2, &minus_b2);
    kaspa_secp256k1_scalar_add(r2, &c1, &c2);
    kaspa_secp256k1_scalar_mul(r1, r2, &kaspa_secp256k1_const_lambda);
    kaspa_secp256k1_scalar_negate(r1, r1);
    kaspa_secp256k1_scalar_add(r1, r1, k);

#ifdef VERIFY
    kaspa_secp256k1_scalar_split_lambda_verify(r1, r2, k);
#endif
}

#ifdef VERIFY
/*
 * Proof for kaspa_secp256k1_scalar_split_lambda's bounds.
 *
 * Let
...
static void kaspa_secp256k1_scalar_split_lambda_verify(const kaspa_secp256k1_scalar *r1, const kaspa_secp256k1_scalar *r2, const kaspa_secp256k1_scalar *k) {
    ...
    kaspa_secp256k1_scalar_mul(&s, &kaspa_secp256k1_const_lambda, r2);
    kaspa_secp256k1_scalar_add(&s, &s, r1);
    VERIFY_CHECK(kaspa_secp256k1_scalar_eq(&s, k));

    kaspa_secp256k1_scalar_negate(&s, r1);
    kaspa_secp256k1_scalar_get_b32(buf1, r1);
    kaspa_secp256k1_scalar_get_b32(buf2, &s);
    VERIFY_CHECK(kaspa_secp256k1_memcmp_var(buf1, k1_bound, 32) < 0 || kaspa_secp256k1_memcmp_var(buf2, k1_bound, 32) < 0);

    kaspa_secp256k1_scalar_negate(&s, r2);
    kaspa_secp256k1_scalar_get_b32(buf1, r2);
    kaspa_secp256k1_scalar_get_b32(buf2, &s);
    VERIFY_CHECK(kaspa_secp256k1_memcmp_var(buf1, k2_bound, 32) < 0 || kaspa_secp256k1_memcmp_var(buf2, k2_bound, 32) < 0);
}
#endif /* VERIFY */
#endif /* !defined(EXHAUSTIVE_TEST_ORDER) */

#endif /* kaspa_secp256k1_SCALAR_IMPL_H */
