...
static void kaspa_secp256k1_fe_from_signed62(kaspa_secp256k1_fe *r, const kaspa_secp256k1_modinv64_signed62 *a) {
...
static void kaspa_secp256k1_fe_to_signed62(kaspa_secp256k1_modinv64_signed62 *r, const kaspa_secp256k1_fe *a) {
...
static const kaspa_secp256k1_modinv64_modinfo kaspa_secp256k1_const_modinfo_fe = {
...
static void kaspa_secp256k1_fe_inv(kaspa_secp256k1_fe *r, const kaspa_secp256k1_fe *x) {
    ...
    kaspa_secp256k1_fe_to_signed62(&s, &tmp);
    kaspa_secp256k1_modinv64(&s, &kaspa_secp256k1_const_modinfo_fe);
    kaspa_secp256k1_fe_from_signed62(r, &s);
...
static void kaspa_secp256k1_fe_inv_var(kaspa_secp256k1_fe *r, const kaspa_secp256k1_fe *x) {
    ...
    kaspa_secp256k1_fe_to_signed62(&s, &tmp);
    kaspa_secp256k1_modinv64_var(&s, &kaspa_secp256k1_const_modinfo_fe);
    kaspa_secp256k1_fe_from_signed62(r, &s);
